...
HD_PWD='C:/ECE_440/project11/project_11/project_11.runs/design_1_handshake_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_handshake_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_handshake_wrapper_0_0.tcl
