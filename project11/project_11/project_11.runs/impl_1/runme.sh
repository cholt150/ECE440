...
HD_PWD='C:/ECE_440/project11/project_11/project_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log handshake_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source handshake_wrapper.tcl -notrace
