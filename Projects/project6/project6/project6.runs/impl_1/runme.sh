...
HD_PWD='F:/ECE 440/project6/project6/project6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALC.tcl -notrace
