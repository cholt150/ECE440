...
HD_PWD='C:/Users/Cory Holt/Desktop/ECE_440/project8/project8/project8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DNA_sequencer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DNA_sequencer.tcl -notrace
