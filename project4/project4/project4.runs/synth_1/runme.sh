...
HD_PWD='F:/ECE 440/project4/project4/project4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALC.tcl
