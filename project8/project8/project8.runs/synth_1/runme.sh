...
HD_PWD='C:/Users/Cory Holt/Desktop/ECE_440/project8/project8/project8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DNA_sequencer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DNA_sequencer.tcl
