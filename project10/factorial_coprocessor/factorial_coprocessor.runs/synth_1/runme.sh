...
HD_PWD='C:/ECE_440/project10/factorial_coprocessor/factorial_coprocessor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log handshake_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source handshake_wrapper.tcl
