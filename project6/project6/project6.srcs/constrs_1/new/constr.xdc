...
create_clock -period 100.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports clk]
...
##IO_L24N_T3_34
#set_property PACKAGE_PIN P16 [get_ports {load_btn}]
...
set_property MARK_DEBUG false [get_nets {spo[0]}]
set_property MARK_DEBUG false [get_nets {spo[1]}]
